...
export const metadata = {
  title: "About",
  description: "gloood is a small, senior team building websites and running paid ads for SMBs across India.",
};

export default function About() {
  const description = "gloood is a small, senior team building websites and running paid ads for SMBs across India.";
  return (
    <>
      <JsonLd
        data={[
          webPageSchema({ url: "/about", title: "About gloood", description, type: "AboutPage" }),
          breadcrumbSchema([
            { name: "Home", href: "/" },
